...
public class HTMLUtil {
    ...
    public static String inspect(Node n) {
        ...
        return ("node: " + n + "\ntext:" + text + "\ntype:" + n.getClass().getName() + " Children:"
    ...
    public static List<HtmlTable> getTables(DomNode page) {
        ...
        list.addAll((List<? extends HtmlTable>) page.getByXPath("//table").stream().filter(e -> e instanceof HtmlTable)
                .map(e -> (HtmlTable) e).collect(Collectors.toList()));
        return list;
    }
